...
class C:
    ...
    VELOCITY_DIR = ROOT_DIR + "velocity/anomalies_freedom0_100/"
    GATHER_DIR = ROOT_DIR + "gather/anomalies_freedom0_100_3sources/"
    DATA_PATH = ROOT_DIR + "data/anomalies_freedom0_100_3sources.bin"
